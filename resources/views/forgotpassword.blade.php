...
<tr>
<td class="img-center" style="font-size:0pt; line-height:0pt; text-align:center;background-image:linear-gradient(to left,#00ad75, #0b7cca) !important; padding: 14px 0"><a href="#" target="_blank"><img src="{{ asset('admin/assets/css/jwp.png') }}" width="225" mc:edit="image_1" border="0" alt="" /></a>
</td>
</tr>
</table>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<div mc:edit="text_4">Verify  Password<p style="font-size: 16px; font-weight:400;">Welcome to <a target="_blank" href="https://owlok.in/jwpl/public/admin/login/">Clindcast Time Logs</a>.</p>
		</div>
		</td>
	</tr>
    <!--<input type="submit" class="btn btn-primary btn-user btn-block" value="Login">-->
    <div class="form-group">
    <center><button type="button" class="btn btn-primary  btn-user btn-block" style=" background-color: #4e73df; border: none;color: white;padding: 15px 32px;
        text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;" > {{$details['password']}} </button></center>
