                ...
                <div class="col-md-12">
                    <form action="{{ route('board') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-3" style="float: left;">
                            <select name="emp_id" class="form-control" style="border-radius: 10px;">
                        ...
                        <div class="col-sm-3" style="float: left;">
                            <select name="group_id" class="form-control" style="border-radius: 10px;">
                               <option value="">Select Group</option>
                                @foreach($groups as $group)
                                <option value="{{ $group->id }}" {{ $group_id  == $group->id ? 'selected="selected"' : '' }}>{{ $group->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-sm-2" style="float: left;">
                            <input type="date" id="date" name="date"  placeholder="Date" value="{{ $date }}" class="form-control" required style="border-radius: 10px;">
                        </div>
                        <div class="col-sm-2" style="float: left;">
                            <button class="btn btn-primary" style="border-radius: 10px;">Search</button>
                        </div>
                    </form>
                    <form action="{{ route('boardPrint') }}" method="post" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div>
                        ...
                        @foreach($employeess as $key => $data)
                            ...
                            <div class="col-md-4" style="float:left;">
                                <div style="background: #0c6ead; padding: 0.75rem 6.25rem; border-radius: 25px">
                                    <h6 class="m-0 font-weight-bold" style=" color: white;text-align: center;">{{$data->name}} {{$data->last_name}}</h6>
                                </div>
                                    ...
                                    <div class="card bg-white border-0 b-shadow-4">
                                        <div class="card-body ">
                                            <form action="{{ route('store_assigntask1') }}" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="submit" class="btn btn-primary" value="Save" style="border-radius: 10px;"> 
                                            </form>
                                        </div>
                                    </div>
                                </div>
