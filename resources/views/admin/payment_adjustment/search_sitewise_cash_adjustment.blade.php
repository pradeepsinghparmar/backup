    ...
    <div class="col-sm-3" style="float: left;">
        ...
        @endif
                       ...
                       <!--  <td>
                          ...
                          @php
                                           $sum_payment_ajustment_cash = \App\Models\PaymentCollect::where('payment_adjustment','1')->where('site_id',$info->site_id)->where('date', '>=',$from_date)->where('date', '<=',$to_date)->get()->sum('cash_received');   
                                            @endphp
