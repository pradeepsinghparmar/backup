...
input[type="month"]:active::after {
  ...
  <div class="container-fluid">
                    ...
                    <div class="row _title-style">
                                        <div class="col-md-10">
                                   <h1 class="h3 mb-2 text-gray-800">Create Adjustment Payment</h1>
                                    </div>
                                     <div class="col-md-2">
        ...
        @endif
                ...
                <div class="col-md-9">                          
<form action="{{ route('store_payment_adjustment') }}" method="post" enctype="multipart/form-data">
@csrf
    <div class="row mb-3">
    ...
    <!--</div>-->
     ...
     <div class="row mb-3">
        <label for="validationCustom02" class="col-sm-3 col-form-label">Cash Adjustment</label>
        <div class="col-sm-9">
            <input type="number" name="cash_received"  min="1" placeholder="Cash Adjustment" class="form-control" id="validationCustom02" required>
        </div>
    </div>
    <!-- <div class="row mb-3">-->
    ...
    <!--</div>-->
     <div class="row mb-3">
      ...
      <div class="row mb-3">
        <label for="validationCustom02" class="col-sm-3 col-form-label">Reason</label>
        <div class="col-sm-9">
            <textarea name="reason"  rows="6" id="reason" placeholder="Enter Reason" class="form-control" id="validationCustom02" required></textarea>
        </div>
    </div>
