                        ...
                        <div class="col-md-9">
                            <form action="{{ route('update_project',$editstaff->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="{{ $editstaff->name }}" placeholder="Project Name" class="form-control" for="validationCustom01" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="validationCustom01" class="col-sm-3 col-form-label required">Assign To</label>
                                    <div class="col-sm-9">
