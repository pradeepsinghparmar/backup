...
@section('content')
  ...
  <div class="container-fluid">
                    ...
                    <div class="row">
                                        <div class="col-md-10">
                                   <h1 class="h3 mb-2 text-gray-800">Total Recharge Summary </h1>
                                    </div>
                                     <div class="col-md-2">
                            ...
                            <div class="table-responsive">
                                <table class="export_example1">
                                    ...
                                    <tbody>
                                         ...
                                         @php $i=0; @endphp
                                         @foreach($data as $d)
                                         @php if($d->price == 0){ continue; } @endphp
                                    @php  $i++; @endphp
                                    
                                    <tr>
                                        <td>{{ $i}}</td>
                                        <td> <a href="{{ route('received_voucher_singel',$d->id) }}" target="_blank"> {{ $d->name}}</a></td>
                                        <td><a href="{{ route('received_voucher_singel',$d->id) }}" target="_blank"> {{ $d->email}}</a></td>
                                        <!--<td>{{ $d->id}}</td>-->
                                        <td>{{ $d->price}}</td>
                                    </tr>
