        ...
        <div class="row">
            ...
            <div class="col-md-2">
                @if(App\Models\Userpermission::get_permission('leave','is_create'))   
                    <a href="{{ route('create_leave') }}" class="btn btn-info btn-icon-split">
                            ...
                            <tr>
                                ...
                                @if(App\Models\Userpermission::get_permission('leave','is_edit') || App\Models\Userpermission::get_permission('leave','is_delete')) 
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-circle btn-sm"  href="{{route('edit_leave', $customer->id)}}"  title="Edit"><i class="fas fa-edit"></i></a>
                                        @endif
