            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">         
                        ...
                        <div class="col-md-9">                          
                            <form action="{{ route('update_all_leave',$leave_edit->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @php $name=''; @endphp
                                @foreach($user as $us)
                                        @if($us->id == $leave_edit->user_id) 
                                        @php $name= $us->name.' '. $us->last_name; @endphp @endif 
                                    @endforeach
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="status" class="form-control">
                                            <option value="">Select</option>
                                            <option value="Applied" @if($leave_edit->status=='Applied') Selected @endif>Applied</option>
                                            <option value="Approved" @if($leave_edit->status=='Approved') Selected @endif>Approved</option>
                                            <option value="Decline"  @if($leave_edit->status=='Decline') Selected @endif>Decline</option>
                                        </select>
                                    </div>
                                </div>
                                <br>
