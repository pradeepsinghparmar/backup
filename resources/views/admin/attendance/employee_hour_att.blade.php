...
.punch-hours{
  ...
  <div class="container-fluid">
                    ...
                    <div class="row">
                                        <div class="col-md-10">
                                   <h1 class="h3 mb-2 text-gray-800">Attendance By Hour List</h1>
                                    </div>
                                    <div class="col-md-2">
                                          <a href="{{ route('employee_att') }}" class="btn btn-dark btn-icon-split">
...
if($userlist->clock_out == ""){
 ...
 $emp_total_hour = App\Models\Attendance::where('month',$m_day)->where('year',$y_day)->where('employee_id', Auth::user()->id)->sum('total_hours');
    ...
    $hourss = $time_diff->h.' hours';
                    ...
                    <div class="border rounded p-3 bg-light">
                        ...
                        @endif
                                            ...
                                            <td><div class="btn btn-primary btn-sm rounded-pill"> {{ $emp_total_hour ?? '0'}} hrs</div></td>
