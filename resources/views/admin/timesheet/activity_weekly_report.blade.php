...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-10">
                <h1 class="h3 mb-2 text-gray-800">Weekly Task Details Report</h1>
            </div>
             <div class="col-md-2">
        ...
        <div class="card shadow mb-4">
            <div class="container-fluid"><br>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('activity_reports_weekly') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="week">
                                                             @foreach($options as $option)
                                                                <option value="{{ $option['value'] }}" @if($option['value']==$week) Selected @endif>({{ $option['week_start'] }}) to ({{ $option['week_end'] }})</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                    ...
                    <br>
                    <form action="{{ route('createWeeklyPDF') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div style="display:none;">
                        <input type="text" name="week1" value="{{ $week }}" class="form-control">
