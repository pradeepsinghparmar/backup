        ...
        <div class="card shadow mb-4">
            <div class="container-fluid"><br>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('activity_reports_monthly') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                    ...
                                                    <div class="col-sm-6">
                                                        <select name="month">
                                                             @foreach($options as $option)
                                                                <option value="{{ $option['value'] }}" @if($option['value']==$month) Selected @endif>({{ $option['month_start'] }}) to ({{ $option['month_end'] }})</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                    ...
                    <br>
                    <form action="{{ route('createMonthlyPDF') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div style="display:none;">
                        <input type="text" name="month1" value="{{ $month }}" class="form-control">
