            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <form action="{{ route('update_vendor',$editstaff->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <label for="validationCustom01" class="col-sm-3 col-form-label">Vendor Id</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="vendor_id" value="{{ $editstaff->vendor_id }}" placeholder="Vendor Id" class="form-control" for="validationCustom01" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
