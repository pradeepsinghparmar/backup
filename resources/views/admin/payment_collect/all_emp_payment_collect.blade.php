...
@section('content')
  ...
  <div class="container-fluid">
                    ...
                    <div class="row">
                                        <div class="col-md-9">
                                   <h1 class="h3 mb-2 text-gray-800">All Cash Received List</h1>
                                    </div>
                                     <div class="col-md-3">
                                     <a href="{{ route('create_payment_collect_for_admin') }}" class="btn btn-info btn-icon-split">
                            ...
                            <div class="table-responsive">
                                <table class="export_example1">
                                  ...
                                  @endforeach
                                        ...
                                        <?php  $last_payment_row = \App\Models\PaymentCollect::where('payment_adjustment','0')->where('site_id',$info->site_id)->orderBy('id','DESC')->first(); 
                                                //dd($last_payment_row->total_amount);
                                        ?> 
                                                    <td>{{ $last_payment_row->total_amount }}</td>
                                                    <td>{{ $last_payment_row->cash_received }}</td>
