  ...
  <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                                    ...
                                    <h3>View Contact</h3>
                                     ...
                                     <div class="col-md-2">
                                         <button type="button" class="btn btn-dark"><a href="{{ route('all_contact_list') }}" style="color:#fff;text-decoration: auto !important;">Back</a></button>   
                                         </div>
                  ...
                  <table class="table table-striped table-bordered">
                    <tbody>
                        ...
                        <td> @foreach($users as $inf)
                                    @if($inf->id == $view_contact_list->user_id)                
                                         {{ $inf->name }}
                                  @endif
                                  @endforeach</td>
                      </tr>
