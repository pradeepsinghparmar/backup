   ...
   @php $i++; @endphp
                                                <tr>
                                                    ...
                                                    <td>{{ date('d M Y',strtotime($info->created_at)) }}</td>
                                                      ...
                                                      <td>
                                                          <a class="btn btn-primary btn-circle btn-sm"  href="{{route('view_all_contact', $info->id)}}"  title="View"><i class="fas fa-eye"></i></a>
                                                  
                                                                        <a   class="btn btn-danger btn-circle btn-sm" onclick="if (!confirm('Are you sure? you want to delete this info')) return false;"   href="{{route('delete_contact_list', $info->id)}}"  title="Delete">
